...
2. Acima da _Grid_ anterior, incluir uma **Caixa de Combinação** para exibir os Marketplaces configurados e ativos, para que o usuário possa definir qual lista deseja visualizar. Incluir também um campo para **Inserção Rápida** de Produto com as funcionalidades de:
...
| Ações    | Enviar para Lista                         | Deve existir uma ação de **"Enviar para Lista"** todos os Produtos selecionados na _Grid_ **Adicionar à Lista**.                                                                                                                                                                                                                  |
...
| A02 | Atualização de Preço de Venda               | Se Usuário atualizar o Preço de Venda de um Produto que está contido na Lista do Marketplace, atualizar o Preço de Venda **obedecendo a Margem de Lucro aplicada ao Produto**. Se **Promoção Ativa** verificar o tipo de Preço: <br> - Se Fixo, manter o Preço considerando a margem de lucro. <br>- Se Percentual, recalular o Preço de Promoção obedecendo a Margem de Lucro e Percentual de Desconto definido na Promoção. |
